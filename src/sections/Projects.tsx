    ...
    <div className="w-full md:container px-6">
      ...
      <div className="flex flex-col mt-10">
        {portfolioProjects?.map((project) => (
          <div
            key={project.title}
            className="bg-gray-800 rounded-3xl relative z-0  after:contents-[''] after:absolute after:inset-0 after:-z-10 overflow-hidden after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 p-8"
          >
            <div className="flex ">
